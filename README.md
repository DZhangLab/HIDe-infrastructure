...
- Tip: When calling a function, in this case "InitLedger", you need to include the contract name before calling the function (ie. "UserRegistry:GetUser" instead of "GetUser").
